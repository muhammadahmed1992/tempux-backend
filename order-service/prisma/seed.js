...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var existingFedEx, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    console.log('Seeding FedEx provider...');
                    return [4 /*yield*/, prisma.shipment_provider.findFirst({
                            where: {
                                name: 'FEDEX',
                                is_deleted: false,
                            },
                ...
                case 1:
                    existingFedEx = _a.sent();
                    if (!!existingFedEx) return [3 /*break*/, 3];
                    // Create FedEx provider
                    return [4 /*yield*/, prisma.shipment_provider.create({
                            data: {
                                name: 'FEDEX',
