...
-- CreateIndex
CREATE UNIQUE INDEX "reviews_ratings_product_id_user_id_key" ON "products"."reviews_ratings"("product_id", "user_id");

-- CreateIndex
CREATE UNIQUE INDEX "favorite_user_id_product_id_key" ON "products"."favorite"("user_id", "product_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "cart_user_id_product_id_key" ON "products"."cart"("user_id", "product_id");

-- CreateIndex
CREATE UNIQUE INDEX "product_sku_key" ON "products"."product"("sku");
...
-- CreateIndex
CREATE UNIQUE INDEX "wear_sign_component_condition_mapping_product_id_watch_comp_key" ON "products"."wear_sign_component_condition_mapping"("product_id", "watch_component_id", "condition_id");
...
-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_color_id_fkey" FOREIGN KEY ("color_id") REFERENCES "products"."color"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_bracelet_color_id_fkey" FOREIGN KEY ("bracelet_color_id") REFERENCES "products"."color"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_dial_color_id_fkey" FOREIGN KEY ("dial_color_id") REFERENCES "products"."color"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_size_id_fkey" FOREIGN KEY ("size_id") REFERENCES "products"."size"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_movement_type_id_fkey" FOREIGN KEY ("movement_type_id") REFERENCES "products"."movement_type"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_inclusion_id_fkey" FOREIGN KEY ("inclusion_id") REFERENCES "products"."product_inclusion"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_tax_rule_id_fkey" FOREIGN KEY ("tax_rule_id") REFERENCES "products"."tax_rule"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_availability_id_fkey" FOREIGN KEY ("availability_id") REFERENCES "products"."availability"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_complication_id_fkey" FOREIGN KEY ("complication_id") REFERENCES "products"."complications"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_case_material_id_fkey" FOREIGN KEY ("case_material_id") REFERENCES "products"."material"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_bracelet_material_id_fkey" FOREIGN KEY ("bracelet_material_id") REFERENCES "products"."material"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_crystal_id_fkey" FOREIGN KEY ("crystal_id") REFERENCES "products"."crystal"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "products"."country"("id") ON DELETE SET NULL ON UPDATE CASCADE;
