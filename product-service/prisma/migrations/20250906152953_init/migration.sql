...
-- CreateTable
CREATE TABLE "products"."ProductCondition" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "ProductCondition_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductCondition_condition_key" ON "products"."ProductCondition"("condition");

-- CreateIndex
CREATE UNIQUE INDEX "ProductCondition_description_key" ON "products"."ProductCondition"("description");
...
-- AddForeignKey
ALTER TABLE "products"."product" ADD CONSTRAINT "product_condition_id_fkey" FOREIGN KEY ("condition_id") REFERENCES "products"."ProductCondition"("id") ON DELETE SET NULL ON UPDATE CASCADE;
